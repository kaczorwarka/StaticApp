    ...
    if (user){
        ...
        let url = `https://f671-83-31-87-60.ngrok-free.app/DB/Runs/get/${runsStatus}/${user.email}/${user.password}`
        fetch(url, {
            method: 'GET'
        })
        .then(response => {
    ...
    function Modify(num) {
        if (updating && num === actualNum) {
            ...
            if (necessaryField) {
                fetch('https://f671-83-31-87-60.ngrok-free.app/DB/Runs/add', {
                    method: 'POST',
                    headers: {
            ...
            let url = `https://f671-83-31-87-60.ngrok-free.app/DB/Runs/put/${oldName}/${user.email}/${user.password}`;
            fetch(url, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
    ...
    function Delete(num) {
        if ((updating || modifing) && num === actualNum) {
            ...
            let url = `https://f671-83-31-87-60.ngrok-free.app/DB/Runs/delete/${name}/${user.email}/${user.password}`
