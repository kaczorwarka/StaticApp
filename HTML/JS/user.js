document.addEventListener('DOMContentLoaded', () => {
    ...
    if (user) {
        ...
        addPhotoButton.addEventListener('change', () => {
            ...
            let url = `https://app-backend-231203142707.azurewebsites.net/DB/Users/uploadImage/${user.email}/${user.password}`;
            fetch(url, {
                method: 'POST',
                body: formData
            })
        ...
        modifyButton.addEventListener('click', () => {
            if (status === 'view') {
                ...
                let url = `https://app-backend-231203142707.azurewebsites.net/DB/Users/put/${user.email}/${user.password}`;
        ...
        function displayImage() {
            let url = `https://app-backend-231203142707.azurewebsites.net/DB/Users/getImage/${user.email}/${user.password}`;
            picture.src = url; 
        }
    }
});
